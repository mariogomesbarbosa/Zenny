...
Repositório recém-criado. O B0 (esqueleto do app) está em revisão no PR #1; nada mais
foi implementado. O roteiro dos blocos está em
[conceito.md](conceito.md#roteiro-proposto) e ainda é uma proposta.
